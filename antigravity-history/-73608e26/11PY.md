...
- **Flujo de Navegación Corregido**: Se ajustó `AuthContext` para permitir que se muestre la Splash Screen antes de cualquier redirección. Al finalizar el video, si el usuario está autenticado, irá directamente a la nueva pantalla de **Selección de Canchas**.
