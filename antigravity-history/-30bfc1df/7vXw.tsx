...
export function AdminCalendarView() {
    ...
    const findBookingForSlot = (day: Date, time: string): BookingWithDetails | undefined => {
        // Construct standard ISO-like string for the slot in Chile time: "YYYY-MM-DD HH:mm"
        const dateStr = format(day, 'yyyy-MM-dd')
        const slotTimeStr = `${dateStr} ${time}`

        // Get the UTC timestamp for this slot as if it were in Chile
        ...
        return allBookings.find(b => {
            ...
            // Check if slot time falls within the booking interval [start, end)
            return slotTime >= startDetails && slotTime < endDetails
        })
    }
