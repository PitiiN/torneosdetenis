            ...
            <Card className="overflow-hidden border-0 bg-card/50">
                <CardContent className="p-0">
                    {slotsLoading ? (
                        ...
                        <div className="flex">
                            {/* Fixed time column */}
                            <div className="flex-shrink-0 w-16 sm:w-20 bg-slate-900 z-10 border-r border-border/30">
                                <div className="p-2 sm:p-3 text-left text-xs sm:text-sm font-bold text-muted-foreground border-b border-border/50 h-[52px] sm:h-[58px] flex items-center">
                                    Hora
                                </div>
                                {validTimeSlots.map((time: string) => (
                                    <div key={time} className="p-2 sm:p-3 text-xs sm:text-sm font-bold text-muted-foreground border-b border-border/30 h-[45px] sm:h-[49px] flex items-center">
                                        {time}
                                    </div>
                                ))}
                            </div>
                                        ...
                                        <tr className="border-b border-border/50">
                                            {weekDays.map((day) => (
                                                <th
                                                    key={day.toISOString()}
                                                    className={cn(
                                                        'p-2 sm:p-3 text-center text-xs sm:text-sm font-semibold border-l border-border/30',
                                                        isToday(day)
