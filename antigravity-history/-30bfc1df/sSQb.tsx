                            ...
                            <table className="w-full min-w-[600px] border-collapse">
                                <thead>
                                    <tr className="border-b border-border/50">
                                        <th className="p-2 sm:p-3 text-left text-xs sm:text-sm font-bold text-muted-foreground bg-slate-900 sticky left-0 z-10 w-16 sm:w-20">
                                            Hora
                                        </th>
                                        {weekDays.map((day) => (
                                            <th
                                ...
                                <tbody>
                                    {validTimeSlots.map((time: string) => (
                                        <tr key={time} className="border-b border-border/30 hover:bg-secondary/10">
                                            <td className="p-2 sm:p-3 text-xs sm:text-sm font-bold text-muted-foreground bg-slate-900 sticky left-0 z-10 border-r border-border/30">
                                                {time}
                                            </td>
                                            {weekDays.map((day) => {
                                                const status = getSlotStatus(day, time)
