                            ...
                            <View style={styles.matchesContainer}>
                                {matches
                                    ...
                                    .map(m => {
                                        ...
                                        const scores = m.score ? m.score.split(' ') : ['-'];

                                        return (
                                            <View key={m.id} style={[styles.matchCard, { paddingVertical: spacing.lg, borderRadius: borderRadius.lg, backgroundColor: colors.surface, borderBottomWidth: 1, borderBottomColor: colors.border }]}>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: spacing.md }}>
                                                    ...
                                                    <View style={{ alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.md }}>
                                                        ...
                                                        <View style={{ flexDirection: 'row', gap: 4 }}>
                                                            {scores.map((setStr: string, sIdx: number) => (
                                                                <View key={sIdx} style={{ backgroundColor: isUnplayed ? colors.background : colors.primary[500], paddingHorizontal: 6, paddingVertical: 2, borderRadius: borderRadius.sm, minWidth: 24, alignItems: 'center' }}>
                                                                    <Text style={{ color: isUnplayed ? colors.textSecondary : '#fff', fontSize: 10, fontWeight: '700' }}>
                                                                        {isUnplayed ? '-' : setStr}
                                                                    </Text>
                                                                </View>
                                                            ))}
