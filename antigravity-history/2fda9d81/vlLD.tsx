                                            ...
                                            return (
                                                <View
                                                    ...
                                                    style={[
                                                        ...
                                                        { height: MATCH_HEIGHT, marginBottom: matchGap }
                                                    ]}
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <TouchableOpacity onPress={() => handleMatchPress(m)} style={{ backgroundColor: isUnplayed ? colors.background : colors.primary[500], paddingHorizontal: 8, paddingVertical: 2, borderRadius: borderRadius.sm }}>
                                                            <Text style={{ color: isUnplayed ? colors.textSecondary : '#fff', fontSize: 11, fontWeight: '700' }}>{isUnplayed ? '-' : m.score.split(' ')[0]}</Text>
                                                        </TouchableOpacity>
                                                    </TouchableOpacity>
                                                    ...
                                                    >
                                                        ...
                                                        <TouchableOpacity onPress={() => handleMatchPress(m)} style={{ backgroundColor: isUnplayed ? colors.background : colors.primary[500], paddingHorizontal: 8, paddingVertical: 2, borderRadius: borderRadius.sm }}>
                                                            <Text style={{ color: isUnplayed ? colors.textSecondary : '#fff', fontSize: 11, fontWeight: '700' }}>{isUnplayed ? '-' : m.score.split(' ')[1] || '0'}</Text>
                                                        </TouchableOpacity>
                                                    </TouchableOpacity>
                                                    {isTBD && (
