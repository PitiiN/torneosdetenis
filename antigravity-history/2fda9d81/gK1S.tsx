    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity onPress={generateMatches} style={styles.actionButton}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.summaryCard}>
                    <View style={styles.summaryRow}>
                        <Ionicons name="tennisball" size={16} color={colors.primary[500]} />
                        <Text style={styles.summaryText}>{tournament.category.toUpperCase()} | {tournament.modality}</Text>
                    </View>
                    <View style={styles.summaryRow}>
                        <Ionicons name="people" size={16} color={colors.textSecondary} />
                        <Text style={styles.summaryTextSecondary}>{players.length} Jugadores inscritos</Text>
                    </View>
                </View>
                ...
                {matches.length === 0 ? (
                    <View style={styles.emptyMatches}>
                        ...
                        <Text style={styles.emptyMatchesText}>No se han generado los cuadros aún.</Text>
                        <TouchableOpacity style={styles.generateBtn} onPress={generateMatches}>
                            <Text style={styles.generateBtnText}>Generar Partido/Cuadro</Text>
                        </TouchableOpacity>
                    </View>
                ) : (
                    <View style={styles.matchesContainer}>
                        {matches.map(m => (
                            <TouchableOpacity key={m.id} style={styles.matchCard} onPress={() => handleMatchPress(m)}>
