                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <TouchableOpacity onPress={() => handleMatchPress(m)} style={{ backgroundColor: isUnplayed ? colors.background : colors.primary[500], paddingHorizontal: 8, paddingVertical: 2, borderRadius: borderRadius.sm, minWidth: 32, alignItems: 'center' }}>
                                                                    <Text style={{ color: isUnplayed ? colors.textSecondary : '#fff', fontSize: 11, fontWeight: '700' }}>
                                                                        {isUnplayed ? '-' : (m.score.includes('-') ? m.score.split('-')[0].trim() : m.score.split(' ')[0])}
                                                                    </Text>
                                                                </TouchableOpacity>
                                                            </TouchableOpacity>
                                                            ...
                                                            >
                                                                ...
                                                                <TouchableOpacity onPress={() => handleMatchPress(m)} style={{ backgroundColor: isUnplayed ? colors.background : colors.primary[500], paddingHorizontal: 8, paddingVertical: 2, borderRadius: borderRadius.sm, minWidth: 32, alignItems: 'center' }}>
                                                                    <Text style={{ color: isUnplayed ? colors.textSecondary : '#fff', fontSize: 11, fontWeight: '700' }}>
                                                                        {isUnplayed ? '-' : (m.score.includes('-') ? m.score.split('-')[1]?.trim() : (m.score.split(' ')[1] || '0'))}
                                                                    </Text>
                                                                </TouchableOpacity>
                                                            </TouchableOpacity>
                                                            {isTBD && (
