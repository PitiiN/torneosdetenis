                ...
                {showForm && (
                    <View style={s.form}>
                        ...
                        <TouchableOpacity style={s.dateBtn} onPress={() => setShowDatePicker(true)}>
                            <Text style={s.dateBtnText}>📅 {eventDate.toLocaleDateString('es-CL')} • {eventDate.toLocaleTimeString('es-CL', { hour: '2-digit', minute: '2-digit' })}</Text>
                        </TouchableOpacity>
                        {showDatePicker && (
                            <DateTimePicker value={eventDate} mode="datetime" display="default" onChange={handleDateChange} />
                        )}
