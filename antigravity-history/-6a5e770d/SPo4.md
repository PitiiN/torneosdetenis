...
- [ ] Implement `LOGO_OBAT.mp4` Splash Screen (`app/index.tsx`)
- [ ] Intercept AuthGate routes to allow Splash
- [ ] Build App Selector Screen (`app/selection.tsx`)
- [ ] Route authenticated users to `/selection` instead of `/(tabs)`
