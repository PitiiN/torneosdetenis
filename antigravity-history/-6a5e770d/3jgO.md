...
- [x] Replace Admin Student placeholder with real list + search
- [x] Create and apply `AdminBottomBar` to most admin screens

## Phase 7 — Admin Daily Management
- [/] Apply `AdminBottomBar` to `schedule.tsx`
- [ ] Implement Admin "Daily View" (like student Home) in `dashboard.tsx`
- [ ] Implement Class Enrollment details popup for Admin
- [ ] Add "Edit Class" and "Add Student Manually" functionality for Admin

## Phase 8 — Enrollment Logic & User Payment UI
- [ ] Add available spots count to user class popup
- [ ] Implement 8-hour cancellation rule
- [ ] Enforce enrollment limit based on paid classes
- [ ] Update User 'Pagos' with transfer info box and upload receipt button
- [ ] Ensure Tournament/Ranking shows "En construcción"
