...
### Splash & Transitions
- [ ] Update Splash Screen to `LOGO_OBAT_BOTE.mp4` (~3s), fix first-load hang
- [ ] Change Admin navigation animation (slide to fade/fluid)

### Global UI Enhancements
- [ ] Improve dark contrast (White text on time blocks)
- [ ] Ensure custom App-styled Pop-ups (Remove native `Alert.alert`)
- [ ] Format all money values to CLP in Admin views
- [ ] Remove "Argregar al calendario" buttons

### User Profile & Payments
- [ ] Add WhatsApp contact button (+56995158428) in Profile
- [ ] Confirm modal before submitting Payment Receipt
- [ ] Show Receipt Rejection reason in user Payments

### Admin Dashboard & Classes
- [ ] Tap empty block in Dashboard to "Crear clase" or "Bloquear"
- [ ] Show blocked blocks to users
- [ ] Remove "Precio (CLP)" from Create Class
- [ ] Cancel class push notification

### Admin Quick Actions & Finance
- [ ] Remove "Agenda" quick access, rename "Lista" to "Alumnos"
- [ ] Student list searchable by letters -> Show full details
- [ ] Finance: Add reject logic + push notification
- [ ] Finance: Fix filters (Pendientes/Aprobados) and remove "Clases asign."
- [ ] Fix Admin "Torneos" view ("En construcción")
- [ ] Add "Config" quick access with "Cambiar a vista Usuario"
- [ ] Fix Admin "Opiniones": Calculate total overall average, not just month
