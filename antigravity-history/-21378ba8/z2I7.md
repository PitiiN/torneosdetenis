...
## Phase 6: Core Features (Push & Extras)
- [x] Push: Pedir permisos y registrar token (`push_tokens`)
- [x] Push: Edge function invocations y linkeo profundo
- [x] Accesibilidad: setup básico en Tailwind y `Expo-Speech` para lectura TTS (Comunicados).
- [x] Documentación y README elaborados.eference
- [ ] High contrast mode
