...
- [ ] Create repo structure `jjvv-mobile/` with required directories
- [ ] Initialize Expo app with TypeScript
- [ ] Configure NativeWind (Tailwind for RN) + global styles
- [ ] Set up environment variables for Supabase
- [ ] Configure Supabase client library

## Phase 2: Database & Backend (Supabase)
- [ ] SQL Migration 001: Extensions, Enums, Tables, Indexes
- [ ] SQL Migration 002: RLS Policies (all tables)
- [ ] SQL Migration 003: Helper functions (is_member_of, has_role)
- [ ] Storage Buckets + Policies (documents, receipts, gallery, alerts)
- [ ] Edge Function: `send_push`

## Phase 3: Auth & Navigation
- [ ] Auth screens (Login, Register, Reset Password)
- [ ] Auth context/provider with Supabase
- [ ] Post-login role detection (memberships.role)
- [ ] Navigation: UserStack vs AdminStack routing
- [ ] Bottom tab navigation for both stacks
