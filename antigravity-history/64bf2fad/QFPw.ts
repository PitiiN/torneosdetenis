...
export type Match = {
    ...
    player1_manual_name?: string | null;
...
export type GroupMember = { id: string; group_id: string; user_id: string | null; manual_name?: string | null; seed: number | null; sort_order: number };
