    ...
    const generateTournament = async (forceIncomplete: boolean = false) => {
        ...
        try {
            ...
            if (format === 'eliminacion' || format === 'consolacion') {
                // Direct Elimination / Consolation Logic
                const neededPlayers = parseInt(playersCount) || 0; // Re-calculate neededPlayers here for clarity
                ...
                while (currentRoundGames >= 1) {
                    let roundName = '';
                    if (currentRoundGames === 1) roundName = 'Final';
                    else if (currentRoundGames === 2) roundName = 'Semifinales';
                    else if (currentRoundGames === 4) roundName = 'Cuartos de Final';
                    else roundName = `Ronda ${Math.log2(neededPlayers / currentRoundGames) + 1}`;
                ...
                // If Consolation, generate another bracket for losers of Round 1
