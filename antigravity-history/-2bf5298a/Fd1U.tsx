        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          {step === 7 && (
            <Card>
              ...
              <AppText tone="muted" style={{ marginTop: 16 }}>
                Nota: Esta accion creara el torneo y generara la estructura inicial "si o si", usando los inscritos actuales (o vacia si no hay).
              </AppText>
            </Card>
          )}
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 16, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.1)" }}>
          ...
          <View style={{ flexDirection: "row", gap: 12 }}>
            ...
            {step < 7 ? (
              ...
              <AppButton title="Generar SI O SI" variant="primary" onPress={onFinish} />
            )}
          </View>
        </View>
      </View>
