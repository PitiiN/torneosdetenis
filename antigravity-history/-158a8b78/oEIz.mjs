...
test("advanceWinnerToNextMatch advances correctly in a simple bracket", () => {
    const matches = [
        { round: 1, matchNumber: 1, player1Id: "p1", player2Id: "p2", winnerId: "p1", status: "FINAL", scoreJson: null },
        { round: 1, matchNumber: 2, player1Id: "p3", player2Id: "p4", winnerId: "p4", status: "FINAL", scoreJson: null },
        { round: 2, matchNumber: 1, player1Id: null, player2Id: null, winnerId: null, status: "PENDING", scoreJson: null }
    ];
