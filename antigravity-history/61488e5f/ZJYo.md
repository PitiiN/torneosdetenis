...
- [ ] Refactor `AdminScreen.tsx` into smaller manageable components:
  - [ ] Extract `TournamentWizard` to separate component/screen
  - [ ] Extract match/draw management to separate views
...
## E) QA & Polish
- [ ] Implement unit tests for `generateCuadro`
- [ ] Implement unit tests for `standings RR`
- [ ] Implement unit tests for `ranking calc`
- [ ] Run `npm run typecheck`, `npm run test`, `npm run build` and fix any issues
- [ ] Review and update `RUNBOOK.md` if necessary
