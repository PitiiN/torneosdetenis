...
- [ ] Consolidate Match Score Editing and Scheduling into a single `MatchEditModal`.
- [ ] Fix 'TBD vs TBD' in Match Editor to correctly display manual names.
- [ ] Ensure winner dropdown in Match Editor shows manual names if available.
- [ ] Restructure Match cards in Admin Screen to a 2-column square grid for better screen usage.
- [ ] Order the generated RR matches by Group Name instead of randomly.
