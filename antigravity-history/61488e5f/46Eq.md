...
- [ ] Refactor `AdminHomeScreen.tsx` text and layout.
- [ ] Refactor `TournamentWizard.tsx` to generate empty brackets/groups without assignments.
- [ ] Refactor `AdminScreen.tsx` to remove the redundant form block.
- [ ] Add `Sorteo` action in `AdminScreen.tsx` to assign players to the generated empty fixtures.
