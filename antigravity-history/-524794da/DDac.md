...
- [ ] **UI/UX Polish**
    - [ ] **Fluid Transitions**: optimize Financial Panel loading.
        - [ ] Separate initial load from field-change load.
        - [ ] Use opacity/overlay instead of full spinner for field changes.
