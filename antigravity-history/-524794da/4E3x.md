...
- [ ] **Fix Admin Tabs**
    ...
    - [/] **Blocks Tab**: Debug why blocks are not displaying. Check API `api/admin/blocks`.
        ...
        - [ ] Update `api/admin/blocks` to include `bookings(status=BLOQUEADA)`.
        - [ ] Update `api/admin/blocks/[id]` to delete either Blocks or Bookings.
        - [ ] Remove "Verification" from Sidebar.
