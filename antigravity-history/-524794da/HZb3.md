...
- [ ] **Fix Admin Tabs**
    ...
    - [/] **Blocks Tab**: Debug why blocks are not displaying. Check API `api/admin/blocks`.
        ...
        - [x] **UI & Recurrence**: Fix dropdown styles and add recurring blocks option.
            ...
            - [x] Fix Calendar Interaction in PatternBookingModal (Replace Native Input with ShadCN Calendar).
            - [x] Fix Core Calendar Component Layout (Enforce min-width and !cursor-pointer to prevent shrinking and cursor issues).
