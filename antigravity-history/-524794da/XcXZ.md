...
- [x] **Debtors by Field & Detail Modal**
    ...
    - [x] Feature: Add bulk cancellation endpoint and UI in modal.
    - [x] Update `GET /api/admin/debtors` to support `fieldId`.
    - [x] Update `GET /api/admin/bookings` to support `userId`.
    - [x] Update `admin/financial/page.tsx` to filter debtors list by field.
