...
- [x] **Debtors by Field & Detail Modal**
    ...
    - [x] **Fix Price Edit**: Ensure input is accessible and saves correctly (reviewed z-index/click prop, seems correct).
    - [x] **Status Revert**: Add "Marcar como Pendiente" capability.
        - [x] Create `api/admin/bookings/bulk-status`.
        - [x] Add button to modal to revert status of selected items.btors list by field.
