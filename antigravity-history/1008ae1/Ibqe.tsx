...
import {
    ...
    RefreshControl, Alert, ActivityIndicator, Image, Clipboard, Modal, TextInput,
} from 'react-native';
...
export default function PaymentsScreen() {
    ...
    const copyToClipboard = () => {
        ...
        useAlertStore.getState().showAlert('Copiado', `Datos bancarios copiados al portapapeles`);
    };
...
load();
    ...
    useAlertStore.getState().showAlert('Error', err.message || 'No se pudo subir');
}
setUploading(false);
    };
                    ...
                    <View key={pack.name} style={[styles.packCard, pack.popular && styles.packPopular]}>
                        {pack.popular ? (
                            ...
                            <View style={[styles.popularBadge, { backgroundColor: 'transparent', borderColor: 'transparent' }]}>
                                <Text style={[styles.popularText, { color: 'transparent' }]}>Placeholder</Text>
                            </View>
                        )}
