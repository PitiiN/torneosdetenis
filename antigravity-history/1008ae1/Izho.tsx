...
const BANK_DATA = [
    ...
    { label: '12345678' },
    { label: '12.345.678-9' },
    { label: 'Escuela de Tenis SpA' },
    { label: 'pagos@escuelatenis.cl' },
];
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            >
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.packsStrip}>
                ...
                {/* Bank transfer data — just values, copyable */}
                ...
                <View style={styles.bankCard}>
                    {BANK_DATA.map((item, i) => (
                        <TouchableOpacity
                            ...
                            onPress={() => copyToClipboard(item.label)}
                            activeOpacity={0.6}
                        >
                            <Text style={styles.bankValue}>{item.label}</Text>
                            <Ionicons name="copy-outline" size={16} color={colors.textTertiary} />
                        </TouchableOpacity>
                    ))}
                    <Text style={styles.bankHint}>Toca para copiar cada dato</Text>
                </View>
                ...
                {receipts.length === 0 ? (
                    <View style={styles.emptyCard}>
                        ...
                        <Text style={styles.emptyText}>Sin comprobantes enviados</Text>
                    </View>
                ) : receipts.map((r) => {
...
const styles = StyleSheet.create({
    ...
    packCard: {
        ...
        padding: spacing.lg, marginLeft: spacing.xl, alignItems: 'center',
        borderWidth: 1, borderColor: colors.border,
    },
    packPopular: { borderColor: colors.primary[500], borderWidth: 2 },
    popularBadge: {
        backgroundColor: colors.primary[500] + '20', borderRadius: borderRadius.full,
        paddingHorizontal: spacing.sm, paddingVertical: 2, marginBottom: spacing.sm,
    },
    popularText: { fontSize: 10, fontWeight: '600', color: colors.primary[400] },
    ...
    bankValue: { fontSize: 15, fontWeight: '600', color: colors.text },
    bankHint: { fontSize: 11, color: colors.textTertiary, textAlign: 'center', marginTop: spacing.sm },
