...
export default function AuthScreen() {
    ...
    async function signUpWithEmail() {
        if (!email.trim() || !password.trim()) {
            return Alert.alert('Error', 'Por favor ingresa un email y contraseña válidos para registrarte.');
        }
        setLoading(true);
        // Supabase auto-logs the user in if email confirmations are disabled.
        ...
        if (error) {
            ...
            if (data.session) {
                ...
                Alert.alert('¡Éxito!', 'Revisa tu correo para verificar la cuenta o inicia sesión si ya probaste.');
            }
        }
        setLoading(false);
    }
