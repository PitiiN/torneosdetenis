                    ...
                    <View style={[styles.modalContent, { flex: 0.9 }]}>
                        ...
                        <ScrollView style={styles.chatList}>
                            ...
                            {requestReplies.map(reply => {
                                ...
                                return (
                                    <View key={reply.id} style={[styles.chatBubble, isMe ? styles.chatBubbleStudent : styles.chatBubbleAdmin]}>
                                        <Text style={[styles.chatText, isMe ? styles.chatTextStudent : {}]}>{reply.message}</Text>
                                        <Text style={[styles.chatTime, isMe ? styles.chatTimeStudent : {}]}>
