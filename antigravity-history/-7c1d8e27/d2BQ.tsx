...
const s = StyleSheet.create({
    safe: { flex: 1, backgroundColor: '#F8FAFC' }, scroll: { padding: 20 }, back: { marginBottom: 16 }, backText: { color: '#2563EB', fontSize: 16, fontWeight: '600' },
    ...
    modalOption: { padding: 14, borderRadius: 10, marginBottom: 6, backgroundColor: '#F8FAFC' },
