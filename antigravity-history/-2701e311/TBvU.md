...
- [ ] Install lucide-react, recharts, zod
- [ ] Create folder structure per blueprint
- [ ] Create `.env.example` with required variables
- [ ] Verify app runs with `npm run dev`

## Phase 2: Database & Security (PASO 2)
- [ ] Create `/supabase/migrations/001_init.sql` with schema
- [ ] Create `/supabase/migrations/002_rls.sql` with RLS policies
- [ ] Apply migrations to Supabase project
- [ ] Configure Storage bucket `payment-proofs`
