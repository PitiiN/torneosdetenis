...
import { getStatusLabel, getStatusBadgeVariant } from '@/lib/bookings/status'
...
export default function AdminBookingsPage() {
    ...
    const getStatusBadge = (status: string) => {
        // Cast to any to avoid strict type checks on existing string prop from component
        const variant = getStatusBadgeVariant(status as any, true)
        const label = getStatusLabel(status as any, true)
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-2xl font-bold">Gestión de Arriendos</h1>
                <p className="text-muted-foreground">
                    Verifica pagos pendientes y gestiona el calendario de arriendos.
                </p>
            </div>
