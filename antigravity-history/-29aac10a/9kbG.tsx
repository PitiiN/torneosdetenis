...
export default function SolicitudDetailScreen({ route, navigation }: any) {
    ...
    const { solicitudes, updateSolicitudStatus, addSolicitudReply } = useAppStore();
        ...
        <SafeAreaView style={s.safe}>
            <ScrollView contentContainerStyle={s.scroll}>
                ...
                <View style={s.replyBox}>
                    ...
                    <TouchableOpacity style={s.sendBtn} onPress={handleSendReply}><Text style={s.sendText}>📤</Text></TouchableOpacity>
                </View>
            </ScrollView>
        </SafeAreaView>
    );
