            ...
            <ScrollView contentContainerStyle={s.scroll}>
                ...
                <View style={s.grid}>
                    {quickActions.map((action, i) => (
                        <TouchableOpacity key={i} style={[s.card, { backgroundColor: action.bg }]} activeOpacity={0.7} onPress={() => navigation.navigate(action.tab)}>
                ...
                {importantAvisos.length > 0 && (
                    <>
                        ...
                        {importantAvisos.map(a => (
                            <TouchableOpacity key={a.id} style={s.infoCard} onPress={() => navigation.navigate('Avisos')} activeOpacity={0.7}>
