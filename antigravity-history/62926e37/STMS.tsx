...
export default function AdminConfigScreen() {
    ...
    const handleUpdateRole = async (role: string) => {
        ...
        if (error) {
            ...
            useAlertStore.getState().showAlert('✅ Rol actualizado', `Rol de ${selectedUser.full_name} cambiado a ${ROLE_LABELS[role] || role}`);
        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.actionRow} onPress={() => router.push('/(admin)/reviews')}>
                        ...
                        <Text style={styles.actionText}>Gestión de Opiniones</Text>
                        <Ionicons name="chevron-forward" size={18} color={colors.textTertiary} />
                    </TouchableOpacity>
                </View>
                                ...
                                renderItem={({ item }) => (
                                    ...
                                    >
                                        <View>
                                            ...
                                            <Text style={styles.userEmail}>{item.email} · <Text style={{ color: colors.primary[400] }}>{ROLE_LABELS[item.role] || item.role}</Text></Text>
                                        </View>
                ...
                <View style={styles.modalOverlaySmall}>
                    <View style={styles.pickerBox}>
                        ...
                        {['student', 'coach', 'admin'].map((r) => (
                            ...
                            >
                                <Text style={styles.pickerItemText}>{ROLE_LABELS[r]?.toUpperCase() || r.toUpperCase()}</Text>
                            </TouchableOpacity>
                        ))}
