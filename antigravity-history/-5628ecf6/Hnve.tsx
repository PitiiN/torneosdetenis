...
export default function ManageAnnouncementsScreen() {
    ...
    const startEdit = (a: any) => {
        setEditId(a.id); setTitle(a.title); setBody(a.body); setPriority(a.priority); setShowForm(true);
    };
    ...
    const handleSave = () => {
        ...
        setTitle(''); setBody(''); setPriority('normal'); setShowForm(false); setEditId(null);
    };
