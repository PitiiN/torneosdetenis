...
export default function ManageAnnouncementsScreen() {
    ...
    const handleSave = async () => {
        ...
        setTitle(''); setBody(''); setLocation(''); setSchedule(''); setPriority('normal'); setSendPush(false); setShowForm(false); setEditId(null);
    };
    ...
    const cancelForm = () => { setShowForm(false); setEditId(null); setTitle(''); setBody(''); setLocation(''); setSchedule(''); setPriority('normal'); };
