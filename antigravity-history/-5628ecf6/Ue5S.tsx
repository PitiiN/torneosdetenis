        ...
        <SafeAreaView style={s.safe}>
            <ScrollView contentContainerStyle={s.scroll}>
                ...
                <View style={s.monthSelector}>
                    <TouchableOpacity onPress={prevMonth} style={s.arrowBtn}><Text style={s.arrowText}>◀</Text></TouchableOpacity>
                    <Text style={s.monthText}>{MONTHS[filterMonth]} {filterYear}</Text>
                    <TouchableOpacity onPress={nextMonth} style={s.arrowBtn}><Text style={s.arrowText}>▶</Text></TouchableOpacity>
                </View>
