                                ...
                                {loadingEnrollments ? (
                                    ...
                                    studentEnrollments.map((enr) => (
                                        <View key={enr.id} style={styles.enrRow}>
                                            ...
                                            <View style={[styles.enrBadge, { backgroundColor: enr.status === 'confirmed' ? colors.success + '20' : colors.error + '20' }]}>
                                                <Text style={[styles.enrBadgeText, { color: enr.status === 'confirmed' ? colors.success : colors.error }]}>
                                                    {enr.status === 'confirmed' ? 'Confirmada' : 'Cancelada'}
                                                </Text>
                                            </View>
                                        </View>
                                    ))
