...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        if (!email || !password) {
            useAlertStore.getState().showAlert('Error', 'Por favor ingresa tu email y contraseña');
            return;
        }
        setLoading(true);
        ...
        setLoading(false);
        if (error) {
            useAlertStore.getState().showAlert('Error', error.message === 'Invalid login credentials'
