...
async function run() {
    ...
    // Find the one for Feb 17 UTC (Feb 16 Chile)
    const booking = bookings.find(b => b.start_at.startsWith('2026-02-17'))

    if (!booking) {
        console.error('No booking found for 2026-02-17 UTC')
        return
    }
