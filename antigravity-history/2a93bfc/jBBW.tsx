...
export default function MoreScreen() {
    ...
    const items = [
        ...
        { title: 'Mis Cuotas', icon: '💸', screen: null },
        { title: 'Documentos', icon: '📁', screen: null },
        { title: 'Mapa del Barrio', icon: '🗺️', screen: 'NeighborhoodMap' },
        { title: 'Mi Perfil', icon: '👤', screen: null },
        { title: 'Preferencias de Accesibilidad', icon: '♿', screen: null },
    ];
