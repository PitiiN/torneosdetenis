...
- [ ] **Modal Enhancements**:
    - [ ] Update `BulkPaymentModal` to accept `month` and filter displayed bookings.
    - [ ] Implement "Edit Price" feature in `BulkPaymentModal` (pencil icon -> input -> save).
    - [ ] Create/Update API to handle price updates.
