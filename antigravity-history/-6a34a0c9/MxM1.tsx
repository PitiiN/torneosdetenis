...
export default function AdminAvailabilityPage() {
    ...
    const getSlotStatus = (day: Date, time: string): 'available' | 'booked' | 'closed' | 'past' | 'pending' => {
        ...
        // This bypasses the API's "10 minute pending" rule which is for public users only
        ...
        // Note: We don't need to check pending here as we already checked allBookings
