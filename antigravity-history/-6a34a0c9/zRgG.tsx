    ...
    const handleSlotClick = (day: Date, time: string) => {
        ...
        if (isMultiSelectMode) {
            if (status === 'available') {
                ...
                const existingIndex = selectedSlots.findIndex(s => `${s.date}-${s.time}` === slotKey)
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        {isMultiSelectMode ? 'Cancelar Selección' : 'Reserva Periódica'}
                    </Button>
                </div>
            </div>
                    ...
                    <CardContent className="py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">
                                Modo selección múltiple: {selectedSlots.length} slot(s) seleccionado(s)
                            </span>
                        </div>
                        <div className="flex gap-2">
                            <Button
            ...
            <div className="flex flex-wrap gap-3">
                ...
                {isMultiSelectMode && (
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 border border-primary/50 text-primary font-medium text-sm">
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className={cn(
                                                                ...
                                                                status === 'available' && isSelected &&
                                                                'bg-primary hover:bg-primary/80 text-white border-primary ring-2 ring-offset-1 ring-primary cursor-pointer',
                                                                status === 'booked' &&
                                                        ...
                                                        >
                                                            {status === 'available' && !isSelected && (isMultiSelectMode ? 'Seleccionar' : 'Reservar')}
                                                            {status === 'available' && isSelected && '✓'}
                                                            {status === 'booked' && (
