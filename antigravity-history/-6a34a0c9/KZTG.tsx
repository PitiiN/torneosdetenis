...
export default function AdminAvailabilityPage() {
    ...
    const fetchWeekBookings = async () => {
        ...
        try {
            ...
            const endDate = format(addDays(currentWeekStart, 7), 'yyyy-MM-dd') // Fetch one extra day to be safe
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-500/50 text-purple-400 font-medium text-sm">
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            {status === 'booked' && (
                                                                <span className="flex items-center justify-center gap-1 w-full overflow-hidden px-1">
                                                                    <Edit2 className="w-3 h-3 flex-shrink-0" />
                                                                    <span className="truncate text-[10px] leading-tight">
                                                                        {booking?.user?.full_name || 'Admin'}
                                                                    </span>
                                                                </span>
                                                            )}
                                                            {status === 'pending' && (
                                                            ...
                                                            {status === 'blocked' && (
                                                                <span className="flex items-center justify-center gap-1 w-full overflow-hidden px-1">
                                                                    ...
                                                                    <span className="truncate text-[10px] leading-tight">
                                                                        {booking?.user?.full_name || 'Bloqueada'}
                                                                    </span>
                                                                </span>
                                                            )}
