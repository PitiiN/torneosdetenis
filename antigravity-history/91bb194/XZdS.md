...
### "PSSecurityException" in PowerShell
If you see an error about scripts being disabled:
1. Use `npm.cmd` instead of `npm`.
   Example: `npm.cmd run dev`

### "ENOENT: no such file or directory, open package.json"
This means you are in the wrong folder.
1. Make sure to `cd` into the project directory first:
   ```powershell
   cd "your/project/path/AppControlHorario"
   ```
