                                ...
                                return (
                                    ...
                                    >
                                        <Text style={styles.classTime}>
                                            {hasClass && format(new Date(cls.start_datetime), 'HH:00')}
                                        </Text>
                                        {hasClass && (
                                            <View style={styles.classInfo}>
                                                <Text style={[styles.category, isCancelled && { textDecorationLine: 'none' }]} numberOfLines={1}>
                                                    {isCancelled ? 'BLOQUEADA' : (cls.category_name || 'General')}
                                                </Text>
                                                {!isCancelled && (
                                                    <Text style={styles.details} numberOfLines={1}>
                                                        {cls.coach_name} · {cls.court_name}
                                                    </Text>
                                                )}
                                            </TouchableOpacity>
                                        );
