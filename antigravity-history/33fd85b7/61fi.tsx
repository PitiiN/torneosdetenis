                ...
                <View style={s.financeCard}>
                    ...
                    <View style={s.finRow}>
                        <View style={s.finItem}>
                            ...
                            <Text style={[s.finValue, { color: '#22C55E' }]}>+${(totalIncome / 1000).toFixed(0)}K</Text>
                        </View>
                        <View style={s.finDivider} />
                        <View style={s.finItem}>
                            <Text style={s.finLabel}>Egresos</Text>
                            <Text style={[s.finValue, { color: '#EF4444' }]}>-${(totalExpense / 1000).toFixed(0)}K</Text>
                        </View>
                        <View style={s.finDivider} />
                        <View style={s.finItem}>
                            <Text style={s.finLabel}>Balance</Text>
                            <Text style={[s.finValue, { color: '#2563EB' }]}>${((totalIncome - totalExpense) / 1000).toFixed(0)}K</Text>
                        </View>
                    </View>
                </View>
