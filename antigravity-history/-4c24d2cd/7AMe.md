...
- [ ] Allow partial class creation when conflicts exist (`app/(admin)/classes/create.tsx`)
- [ ] Add option to remove/change coach in Create Class view
- [ ] Optimize student search to show results only after input (`app/(admin)/classes/[id].tsx`)
- [ ] Verify all refinements
