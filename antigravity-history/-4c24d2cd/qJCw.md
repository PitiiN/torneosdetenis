...
- [ ] Implement physical deletion of classes (with credit recovery)
- [ ] Fix "Blocked" slots in dashboard by removing deleted classes
- [ ] Enhance student search to include email and handle larger lists
- [ ] Ensure deleted classes are also removed from restricted slots
