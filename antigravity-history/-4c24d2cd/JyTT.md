...
- [x] Implement physical deletion of classes (with credit recovery)
- [x] Fix "Blocked" slots in dashboard by removing deleted classes
- [x] Enhance student search to include email and handle larger lists
- [x] Ensure deleted classes are also removed from restricted slots
