...
- [ ] Fix Student history filter logic in Admin
- [ ] Refine Admin Finances History (Hide by default, search-based)
- [ ] Localize Roles to Spanish (Config screen)
- [ ] Implement Cumulative Class Allowance (lifetime pool)
- [ ] Verify Phase 5 refinements
