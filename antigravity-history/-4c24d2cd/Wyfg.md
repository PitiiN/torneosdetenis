...
- [ ] Fix cold start loading hang in `HomeScreen`
- [ ] Fix User Payments month selector (load dependency & effect)
- [ ] Refine Admin Finances (Global Inbox, History search filtering)
- [ ] Implement enrollment restrictions (Past classes)
- [ ] Add month filter to Student Class History in Admin
- [ ] Verify Phase 4 refinements
