...
- [ ] Fix "Usadas" count discrepancy in User Payments (SQL `get_student_class_allowance`)
- [ ] Remove "Ingresos mes actual" from Admin Dashboard
- [ ] Rename "Pagos" to "Finanzas" and unify purple colors in AdminBottomBar
- [ ] Restrict Student List to search results only in Admin Students view
- [ ] Verify Phase 3 refinements
