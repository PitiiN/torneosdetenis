...
- [ ] Implement automatic scrolling for time blocks
- [ ] Fix bottom safe area/padding for phone buttons
- [ ] Add cancel button next to "Crear Clase"
- [ ] Implement recurring class creation logic
