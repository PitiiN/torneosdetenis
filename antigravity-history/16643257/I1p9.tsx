...
export default function FinancialPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const debtorsResponse = await fetch(`/api/admin/debtors?${debtorsParams.toString()}`)
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Debtors List - Only show if a specific field is selected */}
            {fieldFilter !== 'all' && (
                <div className="border rounded-lg bg-[#1e293b] border-slate-700">
                    <div className="p-4 border-b border-slate-700">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Click en un usuario para marcar sus reservas como pagadas y ver historial
                        </p>
                    </div>
                    <div className="divide-y divide-slate-700">
                        {debtors.length === 0 ? (
                            <div className="p-8 text-center text-muted-foreground">
                                No hay usuarios con deuda en esta cancha
                            </div>
                        ) : (
                            debtors.map((debtor) => (
                                <div
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">{debtor.email || debtor.phone}</p>
                                        </div>
                                    </div>
                                    <div className="text-right flex items-center gap-3">
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                {debtor.unpaidBookings.length} reservas pendientes
                                            </p>
                                        </div>
