...
export default function AdminEditClassScreen() {
    ...
    const handleCancelClass = () => {
        useAlertStore.getState().showAlert(
            'Cancelar Clase ⚠️',
            '¿Estás seguro de que deseas cancelar esta clase? Los alumnos inscritos recuperarán sus créditos automáticamente.',
            [
                { text: 'Volver', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            // Also cancel each enrollment to ensure credits are returned
                            // Assuming status 'cancelled' in enrollment table handles credits
                            ...
                            useAlertStore.getState().showAlert('✅ Cancelada', 'La clase ha sido cancelada correctamente.', [
        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            <View style={styles.header}>
                ...
                <View style={styles.headerActions}>
                    <TouchableOpacity onPress={handleCancelClass} disabled={saving} style={styles.cancelHeaderBtn}>
