...
- [x] **Media Pill UI**: Mostrar adjuntos multimedia en hilos como un botón ('Imagen adjunta', 'Video adjunto', 'Audio adjunto') que al ser tocado abra el visor o reproduzca el audio, en lugar de previsualizar el archivo gigante.
- [x] **Audio Unmount Cleanup**: Detener la reproducción de audio al salir de la vista de Avisos.
- [x] **Admin Agenda**: Añadir vista de Agenda para Admin (donde puede agregar eventos) conectada al Storage global.
