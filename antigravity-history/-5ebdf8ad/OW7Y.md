...
- [ ] **Error Crash (Zustand)**: Solucionar `Cannot convert undefined value to object` en `addAnnouncementReply`.
- [ ] **Push Notifications Expo Go**: Evitar error rojo al iniciar en Expo Go SDK 53.
- [ ] **Avisos UI**: Solucionar opción colapsable de mensajes que no aparece y usar `expo-image-picker` para adjuntar fotos reales al hilo.
- [ ] **Encuestas UI**: Separar Encuestas de Avisos en el feed de usuario.
- [ ] **Encuestas Edit**: Permitir al usuario cambiar su voto enviado anteriormente.
- [ ] **Encuestas Admin**: Usar componente DatePicker / Calendar desplegable para la fecha límite.
- [ ] **Favores Admin**: Dar acceso al tablón de Favores al Administrador.
- [ ] **Cuotas User**: Instalar implementacion real de subida de comprobante con `expo-document-picker` o file picker.
- [ ] **Admin Solicitudes**: Revisar por qué el Admin no está recibiendo "Solicitudes" en su bandeja.
