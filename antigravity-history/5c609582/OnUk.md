...
- [x] Compile Corrected Android APK via EAS <!-- id: 10 -->
- [x] Fix class creation time shift (timezone) <!-- id: 12 -->
- [x] Fix category selector carousel behavior <!-- id: 13 -->
- [x] Fix category persistence in class editor <!-- id: 14 -->
- [x] Fix "Create Class" RangeError crash <!-- id: 16 -->
- [x] Fix "Block" timezone shift <!-- id: 17 -->
- [/] Verify fixes and re-compile APK <!-- id: 15 -->
