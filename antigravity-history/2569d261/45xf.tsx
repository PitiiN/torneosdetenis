...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    useEffect(() => {
        ...
        // Solo redirigimos automáticamente SI el usuario está en el grupo de auth
        // y ya tiene sesión (o sea, acaba de loguearse).
        // El resto lo maneja el Splash Screen al inicio.
