...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    // COMENTADO: Dejaremos que app/index.tsx (Splash Screen) maneje la redirección inicial
    // para que el video tenga tiempo de reproducirse.
    /*
    useEffect(() => {
        if (isLoading) return;

        const inAuthGroup = segments[0] === '(auth)';
        const inRoot = !segments[0] || segments[0] === '';
