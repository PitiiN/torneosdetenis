...
export default function AdminSolicitudesScreen() {
    ...
    const filtered = solicitudes.filter(sol => {
        ...
        // Dates are in format "28 Feb 2026" — parse manually
        ...
        <SafeAreaView style={s.safe}>
            <ScrollView contentContainerStyle={s.scroll}>
                ...
                <View style={s.monthSelector}>
                    ...
                    <Text style={s.monthLabel}>{MONTHS[selectedMonth]} {selectedYear}</Text>
                    <TouchableOpacity onPress={() => {
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={s.monthPills}>
                    {MONTHS.map((m, i) => (
...
const s = StyleSheet.create({
    ...
    monthSelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
