            ...
            {nextClass ? (
                <View style={styles.heroCard}>
                    ...
                    <View style={styles.heroActions}>
                        {(profile?.role === 'admin' || differenceInHours(new Date(nextClass.classes.start_datetime), now) >= 24) && (
                ...
                renderItem={({ item }) => {
                    ...
                    return (
                        <View style={[styles.classCard, isPast && styles.cardPast]}>
                            ...
                            {(profile?.role === 'admin' || (!isPast && differenceInHours(new Date(cls.start_datetime), now) >= 24)) && (
