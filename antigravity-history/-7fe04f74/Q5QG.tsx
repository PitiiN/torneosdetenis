        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            >
                ...
                <View style={styles.monthSelector}>
                    ...
                    <TouchableOpacity
                        onPress={handleWeatherCancellation}
                        style={[styles.weatherBtn, { marginLeft: spacing.md }]}
                    >
                        <Ionicons name="cloud-outline" size={20} color={colors.white} />
                        <Ionicons name="rainy-outline" size={14} color={colors.white} style={{ marginTop: -8 }} />
                    </TouchableOpacity>
                </View>
...
const styles = StyleSheet.create({
    ...
    weatherBtn: {
        ...
        paddingHorizontal: 12, height: 40, borderRadius: borderRadius.md,
