...
// Use the local network IP so that Expo Go on a physical device can reach the backend.
// The anon key is the standard local development key from `supabase status`.
