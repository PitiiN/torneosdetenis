...
export default function EmergencyScreen() {
    const call = (number: string) => {
        Linking.openURL(`tel:${number}`).catch(() => Alert.alert('Error', 'No se pudo realizar la llamada.'));
    };
    ...
    return (
        <SafeAreaView style={s.safe}>
            <View style={s.container}>
                ...
                <Text style={s.sub}>Llama rápidamente a los servicios de emergencia</Text>
