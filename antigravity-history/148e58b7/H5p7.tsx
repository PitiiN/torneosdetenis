    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-500/50 text-purple-400 font-medium text-sm shadow-sm hover:bg-purple-500/30 transition-colors cursor-default">
