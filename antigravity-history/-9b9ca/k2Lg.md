...
### 1. Blocked Slots UI Refinement
- **User View (`index.tsx`)**: Cancelled classes now display strictly as **"BLOQUEADA"**, hiding all class details (coach, court, etc.).
- **Admin View (`dashboard.tsx`)**: Consistent behavior implemented to match the user view.
