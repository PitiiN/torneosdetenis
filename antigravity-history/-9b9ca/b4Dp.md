...
- **`my-classes.tsx`**: 
    ...
    - Added `useFocusEffect` to ensure the screen updates whenever the user navigates back to it (e.g., after enrolling in another tab).
    - Modified the 'Futuras' list to always show **all** upcoming classes, including the one highlighted in the "Next Class" hero card, as requested.
