            ...
            if (bookings) {
                ...
                if (allBookings) {
                    setStats({
                        ...
                        pendingPayment: allBookings.filter(b => b.status === 'PENDIENTE_PAGO').length,
                        inVerification: allBookings.filter(b => b.status === 'EN_VERIFICACION').length,
                        confirmed: allBookings.filter(b => b.status === 'PAGADA').length,
                    })
                }
            }
