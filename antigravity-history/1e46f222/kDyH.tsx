...
export default function AdminFinanceScreen() {
    ...
    const filteredReceipts = useMemo(() => {
        ...
        setStats({
            ...
            approved: receipts.filter((r: any) => r.status === 'approved' && isSameMonth(new Date(r.created_at))).length,
    ...
    const isSameMonth = (d: Date) => d.getFullYear() === selectedYear && d.getMonth() === selectedMonth;
