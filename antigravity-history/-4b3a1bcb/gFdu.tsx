        ...
        try {
            ...
            await fetch('https://exp.host/--/api/v2/push/send', {
                ...
                body: JSON.stringify({
                    ...
                    body: 'Las notificaciones push en tu dispositivo están funcionando perfectamente.',
                    data: { test: true },
                }),
            });
            Alert.alert('Notificación enviada 🚀', 'Se ha despachado una notificación push remota hacia este dispositivo. Si estás en iOS, puede que necesites minimizar la aplicación para verla arriba.');
        } catch (e: any) {
            Alert.alert('Error Push', 'No se generó el token o falló el envío. Asegúrate de permisos otrogados.\n' + e.message);
        }
    };
