...
- Grilla semanal igual que la vista de usuario pero con permisos de edición.
- **Creación Rápida**: Click en slot disponible.
- **Edición**: Click en slot reservado.
- **Reservas Periódicas**: Herramienta para bloquear múltiples fechas a la vez.
