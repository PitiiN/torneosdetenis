...
- Verificado que al seleccionar un mes futuro (ej: Abril 2026), el contador de clases pagadas muestra el total acumulado disponible, no 0.

### Finanzas
- Verificado que la pestaña "Historial" no carga datos automáticamente, requiriendo una búsqueda.

### Roles
- Verificado que el selector de roles en Configuración muestra los nombres en español correctamente.

### Filtro de Alumnos
- Verificado que el historial de clases dentro de la ficha del alumno responde correctamente al cambio de mes.
