...
### Manual Verification
- **Deletion**: Verified that deleting a class makes its slot appear completely empty (not "Blocked") in the grid.
- **Search**: Verified being able to find students by typing their email address.
