...
- **Themed pop-up**: The conflict resolution and success Alerts now use the `CustomAlert` component, matching the application's dark theme and palette instead of using native system dialogs.
