...
### 6. Cancellation Rules (Phase 3 & 4)
...
- **Improved (Phase 4)**: Unified the rule in the student view (no more Admin bypass in the "Mis Clases" tab) while keeping full cancellation power in the Admin Panel.
