...
### Manual Verification
- **Admin Edit**: Verified "Estado" is removed and the new cancellation button works as expected.
- **Manual Replication**: Added a student to a class and replicated for 2 weeks. Verified they were enrolled in all 3 classes.
- **Cancellation**: Verified that cancelling a class sends notifications and updates enrollment statuses.
