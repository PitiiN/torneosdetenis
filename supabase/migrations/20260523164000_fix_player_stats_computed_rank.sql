-- Fix get_player_profile_stats to query the correct column 'rank' (instead of 'computed_rank')
-- which is returned by the build_ranking(p_tournament_ids) function.
